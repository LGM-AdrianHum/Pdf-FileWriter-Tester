...
//		PdfQRCode QRCode = new PdfQRCode(Document, "01234", ErrorCorrection.L); //, 8, 4);
		PdfQRCode QRCode = new PdfQRCode(Document,
			"http://www.codeproject.com/Articles/570682/PDF-File-Writer-Csharp-Class-Library-Version", ErrorCorrection.M);
