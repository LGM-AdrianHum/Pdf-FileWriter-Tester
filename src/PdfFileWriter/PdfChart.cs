	...
	public Font CreateFont
		...
		switch(Unit)
			...
			case FontSizeUnit.Point:
				SizeInPixels = (Int32) (FontSize * ImageControl.Resolution / 72.0 + 0.5);
				break;

			case FontSizeUnit.UserUnit:
				SizeInPixels = (Int32) (FontSize * ImageControl.Resolution * Document.ScaleFactor / 72.0 + 0.5);
				break;

			case FontSizeUnit.Inch:
				SizeInPixels = (Int32) (FontSize * ImageControl.Resolution + 0.5);
				break;

			case FontSizeUnit.cm:
				SizeInPixels = (Int32) (FontSize * ImageControl.Resolution / 2.54 + 0.5);
				break;

			case FontSizeUnit.mm:
				SizeInPixels = (Int32) (FontSize * ImageControl.Resolution / 25.4 + 0.5);
				break;
			}
