...
internal class QRCode
	...
	/// </summary>
	public    Int32			MatrixDimension {get; protected set;}				// Code matrix side in bits
	...
	protected static readonly Int16[] FormatInfoArray =
			{
	...
	protected const Byte		White = 0;
	protected const Byte		Black = 1;
	protected const Byte		NonData = 2;
	protected const Byte		Fixed = 4;
	protected const Byte		DataWhite =  White;
	protected const Byte		DataBlack =  Black;
	protected const Byte		FormatWhite =  NonData | White;
	protected const Byte		FormatBlack =  NonData | Black;
	protected const Byte		FixedWhite =  Fixed | NonData | White;
	protected const Byte		FixedBlack =   Fixed | NonData | Black;
