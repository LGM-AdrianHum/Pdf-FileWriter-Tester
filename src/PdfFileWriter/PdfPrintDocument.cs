...
public class PdfPrintDocument : PrintDocument
	...
	/// </summary>
	////////////////////////////////////////////////////////////////////
	public Boolean DocumentInColor
		{
		set
			{
	...
	public void SetMargins
		...
		Margins.Left = (Int32) (LeftMargin * Document.ScaleFactor / 0.72 + 0.5);
		Margins.Top = (Int32) (TopMargin * Document.ScaleFactor / 0.72 + 0.5);
		Margins.Right = (Int32) (RightMargin * Document.ScaleFactor / 0.72 + 0.5);
		Margins.Bottom = (Int32) (BottomMargin * Document.ScaleFactor / 0.72 + 0.5);
		return;
		}
	...
	public void AddPagesToPdfDocument()
		...
		for(Int32 ImageIndex = 0; ImageIndex < PageInfo.Length; ImageIndex++)
			...
			// crop
				...
				ImageControl.CropRect.X = (Int32) (ImageWidth * PageCropRect.X / PageWidth + 0.5);
				ImageControl.CropRect.Y = (Int32) (ImageHeight * PageCropRect.Y / PageHeight + 0.5);
				ImageControl.CropRect.Width = (Int32) (ImageWidth * PageCropRect.Width / PageWidth + 0.5);
				ImageControl.CropRect.Height = (Int32) (ImageHeight * PageCropRect.Height / PageHeight + 0.5);
