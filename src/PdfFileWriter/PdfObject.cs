...
public class PdfObject : IComparable<PdfObject>
	...
	internal	Int64				FilePosition;		// PDF file position for this indirect object
	...
	internal	Boolean				NoCompression;

	private  static String[]		ResCodeStr = {"/Font <<", "/Pattern <<", "/Shading <<", "/XObject <<", "/ExtGState <<"};
	internal static String			ResCodeLetter = "FPSXG";
	...
	internal PdfObject
			...
			String		PdfDictType = null	// object type (i.e. /Catalog, /Pages, /Font, /XObject)
			)
		{
