...
public class PdfDocument : IDisposable
	...
	/// </summary>
	public static readonly String RevisionNumber = "1.20.0";

	/// <summary>
	/// Library revision date
	/// </summary>
	public static readonly String RevisionDate = "2018/07/15";
	...
	public void CreateFile()
		...
		// objects
		for(Int32 Index = 0; Index < ObjectArray.Count; Index++) if(ObjectArray[Index].FilePosition == 0) ObjectArray[Index].WriteObjectToPdfFile();
